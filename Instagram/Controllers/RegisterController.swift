...
class RegisterController: UIViewController {
    ...
    let goToLoginButton: UIButton = {
        ...
        attributedString.append(NSAttributedString(string: "Log in here!", attributes: [NSAttributedString.Key.foregroundColor : #colorLiteral(red: 0.4745098054, green: 0.8392156959, blue: 0.9764705896, alpha: 1), NSAttributedString.Key.font: UIFont.systemFont(ofSize: 16, weight: .regular)] ))
    ...
    private func setupViews() {
        ...
        stackView.heightAnchor.constraint(equalToConstant: 330).isActive = true
